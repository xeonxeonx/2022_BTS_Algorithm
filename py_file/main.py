...
#-------------------------------------------------------------------------------
###Directory Setting
PATH_BASE_DIR = "/home/dais02/dais_BTS/2022_BTS_Project"
PATH_TRAIN_CSV = PATH_BASE_DIR + "/csv/csv_file/"
PATH_PREDICT_CSV = PATH_BASE_DIR + "/csv/csv_predict_file/"
PATH_CSV_INFO = PATH_BASE_DIR + "/csv/csv_file_info/"
PATH_TRAIN_IMAGE = PATH_BASE_DIR + "/image/image_file/"
PATH_PREDICT_IMAGE = PATH_BASE_DIR + "/image/image_predict_file/"

PATH_TRAIN_SOUND = PATH_BASE_DIR + "/sound/sound_file/"
PATH_PREDICT_SOUND = PATH_BASE_DIR + "/sound/sound_predict_file/"

PATH_PROCESS_LOG = PATH_BASE_DIR + "/process_log/"
PATH_MODEL = PATH_BASE_DIR + "/training_model/"
PATH_PREDICT_RESULT = PATH_BASE_DIR + "/result/Predict_result/"


PATH_PARAMS = PATH_BASE_DIR + "/parameter(json)/"
...
async def run_model(filename: str = None, model:str = None):
    global DOCKER_RUN
    command = "echo 'ilovedaislab##12' | sudo -S docker run -i --rm --gpus ''device=1'' -v /home/dais02/dais_BTS/2022_BTS_Project:/BTS test:0.1 BTS/py_file/test.py 'BTS/parameter(json)/{}.json' &".format(filename)
...
async def run_model(model:str):
    print(model)
    command = "echo 'ilovedaislab##12' | sudo -S docker run -i --rm --gpus ''device=1'' -v /home/dais02/dais_BTS/2022_BTS_Project:/BTS predict:0.1 BTS/py_file/predict.py 'BTS/parameter(json)/{}.json' &".format(model)
